...
namespace restaurantSystem
{
    public partial class RegisterForm : Form
    {
        ...
        { 
            ...
            DB db = new DB();
            SqlCommand command = new SqlCommand("INSERT INTO users (firstname, lastname, emailaddress, username, password, category) VALUES (@fn, @ln, @email, @usn, @pass, @cat)", db.getConnection());
            ...
            command.Parameters.Add("@pass", SqlDbType.VarChar).Value = textpassword.Text;
            command.Parameters.Add("@cat", SqlDbType.VarChar).Value = "customer"; // Set the category to "customer"
...
db.closeConnection();
        ...
        public Boolean checkUsername()
        {
          ...
          //  SqlCommand command = new SqlCommand("SELECT * FROM users WHERE username = @usn", db.getConnection());
            ...
            SqlCommand command = new SqlCommand("INSERT INTO users (firstname, lastname, emailaddress, username, password) VALUES (@fn, @ln, @email, @usn, @pass)", (SqlConnection)db.getConnection());
